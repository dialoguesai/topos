...
SUPPORTED_MESSAGE_TYPES = [
    ...
    "permissions_v2_evidence_review_queue",
    "permissions_v2_evidence_review_read",
    "permissions_v2_evidence_review_record",
    "permissions_v2_evidence_review_revoke",
    "permissions_v2_evidence_totals",
    ...
    "promote_fact_conflict",
    "put_community_name",
    "put_conversation_context",
    "put_conversation_context_llm_config",
    "put_data_explorer_table_prefs",
    "put_derivation_pack",
    "put_disk_space_policy",
    ...
    "signal_affinity_pairs",
    "signal_affinity_recompute",
    "signal_affinity_status",
    "signal_attention_dashboard",
    "signal_blackhole_entity",
    "signal_blackhole_record",
    "signal_data_health",
    ...
    "signal_retire_intent",
    "signal_search_vectors",
    "signal_set_worn_badge",
    "signal_timeline_daily",
    "signal_unblackhole_entity",
    "signal_unblackhole_record",
    "signal_update_brief",
    "signal_upload",
