# Frozen compatibility oracle from engine81c1e9c65bb59dcd18650ac316df36ed9e10c145.
# Original fact_policy.py SHA-256: bee3dc870812a6e0ab6a05cea49488099973576169063a98eb1354c8d4e16fe1
# Only relative imports below are rewritten for test loading; never import from runtime.
...
from topos.permissions_v2.contract import Binding, Number, Only, StrictModel, evaluate_predicate
from topos.permissions_v2.evidence import (MAX_DEPTH, MAX_NODES, EvidenceIdentity, Qualification,
    QualifiedEvidence, _json, _key, _row_revision)
from topos.permissions_v2.fact_projection import ReviewedFactProjection, _SENSITIVITY, _current, prepare_fact_projection
from topos.permissions_v2.fact_contract import (CAPABILITY, EVALUATOR, VOCABULARY, PURPOSE, PROJECTION_VERSION, VIEW,
