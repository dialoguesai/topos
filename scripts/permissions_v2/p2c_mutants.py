...
TESTS = ["tests/permissions_v2/" + name for name in (
    ...
    "test_message_search_ledger.py", "test_message_search_boundary.py")]
...
MUTANTS = [
    ...
    ("recheck_any_verdict_from_index", P + "search_release.py",
    ...
    ("no_sweep_in_request", P + "search_release.py",
    ...
    ("sweep_ignores_deleted_rows", P + "search_index.py",
     'if row is None or row[0] not in (None, "", 0):', "if False:"),
