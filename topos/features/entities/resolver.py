...
def normalize_name(name: str) -> str:
    ...
    # "Altman" — 26 such twins in the first live graph ("Nouriel Roubini's",
    # "Woddy Guthrie's", "School's"). Requiring the apostrophe keeps names that
...
class EntityResolver:
    ...
    def _is_mergeable_candidate(self, candidate_id: str) -> bool:
        ...
        proposed a never-mentioned contact, among them "Alex Karp" (the Palantir
        CEO) offered as the owner's contact "Alex", "Alexis" as "Alex", "Alice"
        as "Allie", "Dan" as "Dan SoundBetter" — first names colliding, not
        identities matching.
